...
![Results vs Time Maps Icon for RiverFlow2D](img/icon5.png){ width=10% }

Users have the following options available in the mapping tool menu:

![Results vs Time Maps Menu for RiverFlow2D](img/mapping_menu_rf2d.png){ width=50% }
...
![Results vs Time Maps Dialog for RiverFlow2D](img/results_vs_time_maps_dialog_rf2d.png){ width=100% }
...
![Results vs Time Maps Menu for RiverFlow2D](img/mapping_menu_resultsvstime.png){ width=50% }
...
![Maximum Result Maps Dialog](img/mapping_maxresults_dialog.png){ width=100% }

You can reach this dialog by clicking on the *Maximum Result Maps* button in the *Results vs Time Maps* tool:

![Maximum Result Maps Menu](img/mapping_maxresults_menu.png){ width=50% }
...
![Maximum Result Maps Menu for RiverFlow2D](img/mapping_maxresults_menu.png){ width=50% }
...
### Dialog Window
![Time-Depth Dialog for RiverFlow2D](img/mapping_time_depth_dialog_rf2d.png){ width=0.8\textwidth }
...
![Time-to-Depth Maps Menu](img/mapping_t2d_menu.png){ width=50% }
