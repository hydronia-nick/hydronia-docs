...
**Results vs Time Maps Icon for RiverFlow2D**

Users have the following options available in the mapping tool menu:

**Results vs Time Maps Menu for RiverFlow2D**
...
### Dialog Window
**Results vs Time Maps Dialog for RiverFlow2D**
...
**Results vs Time Map Vector Skip Frequency**
...
| --- | --- | --- |
| Map Type List | *checkbox list* | List of available maximum value map types that can be selected for visualization. |
| Cell Maps | *checkbox* | Enables cell-based (vector polygon) map output. Checked by default. |
| Raster Maps | *checkbox* | Enables raster map output. |
...
The Maximum Result Maps tool can generate maximum value maps for the following parameters:

| Velocity Magnitude | m/s or ft/s | Maximum flow velocity magnitude reached at each location during the simulation. |
| --- | --- | --- |
| Depth | m or ft | Maximum water depth reached at each location during the simulation. |
| Maximum Flood Area | n/a | Polygon outlining the maximum extent of flooding throughout the simulation. |
| WSE (Water Surface Elevation) | m or ft | Maximum water surface elevation reached at each location during the simulation. |
| Depth x Velocity | m²/s or ft²/s | Maximum product of depth and velocity (DV) reached at each location, used for hazard assessment. |
| Maximum Shear Stress | N/m² or lbf/ft² | Maximum bed shear stress reached at each location during the simulation (available when sediment transport module is active). |
| Impact Force | N/m² or lbf/ft² | Maximum impact force reached at each location, calculated from flow momentum and density. |
| DT Limiting Times | dimensionless | Time step limiting factors at each computational cell, showing areas controlling simulation stability. |
| Maximum Bed Elevation | m or ft | Maximum bed elevation reached at each location during the simulation (available when sediment transport module is active). |
| Minimum Bed Elevation | m or ft | Minimum bed elevation reached at each location during the simulation (available when sediment transport module is active). |
| Maximum Erosion Depth | m or ft | Maximum erosion depth reached at each location during the simulation (available when sediment transport module is active). |
| Maximum Deposition Depth | m or ft | Maximum deposition depth reached at each location during the simulation (available when sediment transport module is active). |
...
**Enabling Maximum file output in the Hydronia Data Input Program**

2.  From the *Results vs Time Maps* menu, click on *Maximum Result Maps*. ![](img/icon5.png){ width=5% }.

    

**Maximum Result Maps Menu for RiverFlow2D**
...
**Maximum Result Maps Checkboxes**
...
**Maximum Result Maps Output Options**
...
### Dialog Window
**Time-Depth Dialog for RiverFlow2D**
...
2.  From the *Results vs Time Maps* menu, click on *Time-to-Depth Maps* ![](img/icon5.png){ height=5% }.

    

**Time-to-Depth Maps Menu**
...
**Time-to-Depth Maps Output Options**
...
**Enabling Hazard file output in the Hydronia Data Input Program**
...
**Hazard Intensity Maps Menu for RiverFlow2D**
...
**Hazard Intensity Maps Output Options**
...
### Dialog Window
**Concentrations and Properties vs Time Maps Dialog for RiverFlow2D**
...
**Concentrations and Properties vs Time Maps Menu for RiverFlow2D**
...
**Output Options for Concentrations and Properties vs Time Maps**
