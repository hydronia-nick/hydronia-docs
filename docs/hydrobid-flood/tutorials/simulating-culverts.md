...
![Culvert scheme.](img/4-1.png){ width=50% }
...
![Example of the tutorial loaded in QGIS.](img/4-2.png){ width=.8\textwidth }
...
2.  In the window select the Culverts checkBox, as shown:
    ...
    ![Plugin to add a New Template Layer.](img/4-3_hb.png){ width=60% }
...
![Final mesh.](img/4-7.png){ width=50% }
...
![Plugin window to export the files.](img/4-8_hb.png){ width=60% }
...
![Control data panel.](img/4-9.png){ width=90% }
...
![Culverts component data panel.](img/4-10.png){ width=90% }
...
![Runtime graphics.](img/4-11.png){ width=90% }
...
![Culvert1 output file.](img/4-12.png){ width=75% }
