...
![QGIS interface indicating window areas.](img/hbfwindowareas.png){ width=80% }
...
![Plugins window showing activated HydroBID Flood.](img/hbfinstallplugin.png){ width=100% }
...
![Create New RiverFlow2D Project.](img/2-4s_hb.png){ width=30% }
...
![Export RiverFlow2D dialog.](img/2-33_hb.png){ width=50% }
