...
**Polygon of the area with limited erosion.**
...
**Window for input the polygon parameters of MaximumErosionDepth layer.**
...
**Maps of elevation difference of the river bed between the initial time and at the end of the run.**
